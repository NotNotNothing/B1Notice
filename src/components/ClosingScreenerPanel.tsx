  ...
  return (
    <div className="space-y-6">
      <Card className="rounded-3xl border border-terminal-border-default bg-white/90 shadow-sm backdrop-blur dark:border-terminal-border-default dark:bg-surface-panel/80">
        ...
        <CardContent className="grid gap-4 lg:grid-cols-2">
          <div className="space-y-4 rounded-lg border border-terminal-border-default p-4 dark:border-slate-700">
            ...
            <div className="space-y-3 rounded-lg border border-terminal-border-default p-3 dark:border-slate-700">
              <div>
              ...
              <div className="flex gap-2">
                <Button
                  ...
                  className="rounded-md"
                  onClick={() =>
                    setRule((current) => ({ ...current, mode: "BASIC" }))
                  }
                >
                  基础条件
                </Button>
                <Button
                  ...
                  className="rounded-md"
                  onClick={() =>
                    setRule((current) => ({ ...current, mode: "FORMULA" }))
                  }
                >
                  通达信公式
                </Button>
          ...
          {rule.mode === "FORMULA" ? (
            <div className="space-y-4 lg:col-span-2">
              <div className="rounded-lg border border-terminal-border-default p-4 dark:border-slate-700">
                  ...
                  {testResult && (
                    <div className="flex items-center gap-2 text-sm">
                      <span className="text-muted-foreground dark:text-slate-300">
                        测试结果: {testResult.matchedCount}/
                        {testResult.totalTested} 命中
                      </span>
                  ...
                  <div className="mt-4 space-y-2">
                    ...
                    <div className="max-h-[300px] space-y-2 overflow-y-auto">
                      {testResult.matchedStocks.map((stock) => (
                        <div
                          key={stock.symbol}
                          className="flex items-center justify-between rounded-lg border border-terminal-border-default p-3 dark:border-slate-700"
                        >
                          <div>
                ...
                {testResult && testResult.errors.length > 0 && (
                  <div className="mt-4 space-y-2">
                    ...
                    <div className="max-h-[150px] space-y-1 overflow-y-auto text-sm text-muted-foreground dark:text-slate-300">
                ...
                <div className="mt-4 space-y-2 text-sm text-muted-foreground dark:text-slate-300">
                  <p>
            ...
            <div className="grid gap-4 rounded-lg border border-terminal-border-default p-4 dark:border-slate-700 sm:grid-cols-2">
              <div className="space-y-2">
              ...
              <div className="space-y-2 sm:col-span-2">
                <div className="flex items-center justify-between rounded-md border border-terminal-border-default px-3 py-2 dark:border-slate-700">
                  <div>
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <Card className="rounded-3xl border border-terminal-border-default bg-white/90 shadow-sm dark:border-terminal-border-default dark:bg-surface-panel/80">
      ...
      <div className="grid grid-cols-1 gap-4 xl:grid-cols-2">
        {results?.matchedStocks.length ? (
          results.matchedStocks.map((stock) => (
            ...
            >
              <CardHeader className="flex flex-row items-start justify-between gap-3">
                ...
                <Badge className="bg-surface-panel text-white dark:bg-surface-panel dark:text-slate-900">
                  {stock.market}
                </Badge>
              </CardHeader>
                ...
                <div className="flex flex-wrap gap-2">
                  {stock.reasons.map((reason) => (
                    <Badge
                      ...
                      variant="outline"
                      className="rounded-full border-terminal-border-default text-foreground dark:border-slate-700 dark:text-slate-200"
                    >
                      {reason}
                    </Badge>
                  ))}
          ...
          <Card className="rounded-3xl border border-dashed border-terminal-border-default bg-white/80 shadow-sm xl:col-span-2 dark:border-slate-700 dark:bg-surface-panel/70">
            <CardContent className="flex min-h-[220px] flex-col items-center justify-center gap-3 p-8 text-center">
              <SearchCheck className="h-10 w-10 text-muted-foreground dark:text-muted-foreground" />
              <div>
